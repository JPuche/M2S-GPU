...
extern struct str_map_t cache_nway_evict_policy_map;
...
enum cache_nway_evict_policy_t
{
        cache_nway_evict_policy_invalid = 0,
        cache_nway_evict_policy_exclusive,
	cache_nway_evict_policy_lru,
        cache_nway_evict_policy_next,
        cache_nway_evict_policy_random
};
...
struct cache_set_t
{
	...
	long long misses;
	long long accesses;
	long long penalty_accesses;
	long long penalty_latency;
