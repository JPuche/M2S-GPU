...
void add_evict_and_travel_time_l2_MM(long long invalidation_time, long long evict_time, long long l2_to_mm_cycles)
{
    mem_stats.mod_level[2].invalidation_time += invalidation_time;
    mem_stats.mod_level[2].evict_time += evict_time;
    mem_stats.mod_level[2].l2_to_mm_cycles += l2_to_mm_cycles;
    mem_stats.mod_level[2].evict_count++;
}

void add_evict_and_travel_time_l2_MM_extra(long long invalidation_time, long long evict_time, long long l2_to_mm_cycles)
{
    mem_stats.mod_level[2].invalidation_time_extra += invalidation_time;
    mem_stats.mod_level[2].evict_time_extra += evict_time;
    mem_stats.mod_level[2].l2_to_mm_cycles_extra += l2_to_mm_cycles;
    mem_stats.mod_level[2].evict_count_extra++;
}
...
fran_debug_ipc("evictions_L2 forced_evictions_L2 bw_l1 bw_l2 bw_MM counter_load_action_retry cycles_load_action_retry counter_load_miss_retry cycles_load_miss_retry counter_nc_store_writeback_retry cycles_nc_store_writeback_retry counter_nc_store_action_retry cycles_nc_store_action_retry counter_nc_store_miss_retry cycles_nc_store_miss_retry accesses_with_retries invalidations");
/*
...
fran_debug_ipc(" evict_time invalidation_time l2_to_mm_cycles evict_count evict_time_extra invalidation_time_extra l2_to_mm_cycles_extra evict_count_extra accesses_MM_per_1kcycles");
fran_debug_ipc(" accesses_MM_per_1kcycles_read_reply_none accesses_MM_per_1kcycles_read_reply_ack accesses_MM_per_1kcycles_read_reply_ack_data accesses_MM_per_1kcycles_read_reply_ack_data_sent_to_peer accesses_MM_per_1kcycles_read_reply_ack_error accesses_MM_per_1kcycles_write_reply_none accesses_MM_per_1kcycles_write_reply_ack accesses_MM_per_1kcycles_write_reply_ack_data accesses_MM_per_1kcycles_write_reply_ack_data_sent_to_peer accesses_MM_per_1kcycles_write_reply_ack_error bytes_L2_to_MM bytes_MM_to_L2");
...
void add_forced_eviction(int level)
{
	mem_stats.mod_level[level].forced_evictions++;
}
...
{
    mem_stats.mod_level[level].ics_cycles_dir_locked += cycles;
    mem_stats.mod_level[level].ics_cycles_dir_locked_count++;
}

void add_L2_dir_collision()
{
    mem_stats.mod_level[2].ics_dir_collision++;
}
...
fran_debug_ipc("%lld ",mem_stats.mod_level[2].forced_evictions - instrucciones_mem_stats_anterior.mod_level[2].forced_evictions);
...
/*
  ...
  fran_debug_ipc("%lld ",mem_stats.latencias_load_hit->wavefront_access);
	...
	fran_debug_ipc("%lld ",mem_stats.latencias_nc_write->access);
        ...
        fran_debug_ipc("%lld ",mem_stats.mod_level[2].l2_to_mm_cycles);
        fran_debug_ipc("%lld ",mem_stats.mod_level[2].evict_count);
        
        fran_debug_ipc("%lld ",mem_stats.mod_level[2].evict_time_extra);
        fran_debug_ipc("%lld ",mem_stats.mod_level[2].invalidation_time_extra);
        fran_debug_ipc("%lld ",mem_stats.mod_level[2].l2_to_mm_cycles_extra);
        fran_debug_ipc("%lld ",mem_stats.mod_level[2].evict_count_extra);
        
        fran_debug_ipc("%lld ",mem_stats.mod_level[3].accesses_MM_per_1kcycles);
        mem_stats.mod_level[3].accesses_MM_per_1kcycles = 0;
        
        fran_debug_ipc("%lld ",mem_stats.mod_level[3].accesses_MM_per_1kcycles_read[reply_none]);
        fran_debug_ipc("%lld ",mem_stats.mod_level[3].accesses_MM_per_1kcycles_read[reply_ack]);
        fran_debug_ipc("%lld ",mem_stats.mod_level[3].accesses_MM_per_1kcycles_read[reply_ack_data]);
        fran_debug_ipc("%lld ",mem_stats.mod_level[3].accesses_MM_per_1kcycles_read[reply_ack_data_sent_to_peer]);
        fran_debug_ipc("%lld ",mem_stats.mod_level[3].accesses_MM_per_1kcycles_read[reply_ack_error]);
        fran_debug_ipc("%lld ",mem_stats.mod_level[3].accesses_MM_per_1kcycles_write[reply_none]);
        fran_debug_ipc("%lld ",mem_stats.mod_level[3].accesses_MM_per_1kcycles_write[reply_ack]);
        ...
        mem_stats.mod_level[3].accesses_MM_per_1kcycles_read[reply_ack_data] = 0;
        mem_stats.mod_level[3].accesses_MM_per_1kcycles_read[reply_ack_data_sent_to_peer] = 0;
        mem_stats.mod_level[3].accesses_MM_per_1kcycles_read[reply_ack_error] = 0;
        mem_stats.mod_level[3].accesses_MM_per_1kcycles_write[reply_none] = 0;
        mem_stats.mod_level[3].accesses_MM_per_1kcycles_write[reply_ack] = 0;
        ...
        fran_debug_ipc("%lld ",mem_stats.mod_level[1].ics_cycles_dir_locked_count);
        fran_debug_ipc("%lld ",mem_stats.mod_level[2].ics_cycles_dir_locked);
        fran_debug_ipc("%lld ",mem_stats.mod_level[2].ics_cycles_dir_locked_count);
        fran_debug_ipc("%lld ",mem_stats.mod_level[1].ics_accesses);
        fran_debug_ipc("%lld ",mem_stats.mod_level[1].ics_normal_hit);
        fran_debug_ipc("%lld ",mem_stats.mod_level[1].ics_aux_hit);
        fran_debug_ipc("%lld ",mem_stats.mod_level[2].ics_accesses);
        fran_debug_ipc("%lld ",mem_stats.mod_level[2].ics_normal_hit);
        fran_debug_ipc("%lld ",mem_stats.mod_level[2].ics_aux_hit);
